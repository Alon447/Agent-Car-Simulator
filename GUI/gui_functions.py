...
class CarNavigationGUI:
    ...
    def add_new_car(self):
        # Use custom dialog to gather parameters
        prompts = ["Car ID:", "Source location:", "Destination location:", "Routing algorithm:"]
        input_dialog = CustomInputDialog(self.new_window, "Add New Car", prompts)
        if input_dialog.result:
            car_id, car_src, car_dest, car_routing = input_dialog.result
            print("Adding new car:")
            print("  ID:", car_id)
            print("  Source:", car_src)
            print("  Destination:", car_dest)
            print("  Routing Algorithm:", car_routing)
