...
from Utilities.Getters import get_random_src_dst, get_far_src_dst
...
SM = Simulation_manager.Simulation_manager(PLACE_NAME, 7 * DAY, TRAFFIC_LIGHTS, Rain_intensity, ADD_TRAFFIC_WHITE_NOISE, START_TIME1)
# CM = SM.car_manager
RN = SM.road_network
...
for i in range(600):
    ...
    print(src1, dst1)
    cars.append(Car.Car(i, src1, dst1, START_TIME1, RN, route_algorithm = "q", use_existing_q_table = USE_ALREADY_GENERATED_Q_TABLE))

src2, dst2 = 250, 207
src4, dst4 = 558, 735
src3, dst3 = get_random_src_dst(RN)
# cars.append(Car.Car(1, src3, dst3, START_TIME1, RN, route_algorithm="q",use_existing_q_table = USE_ALREADY_GENERATED_Q_TABLE))
