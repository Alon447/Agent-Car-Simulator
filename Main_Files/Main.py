...
src2, dst2 = get_random_src_dst(RN)
cars.append(
    Car.Car(3, src1, dst1, START_TIME2, RN, route_algorithm="sp", use_existing_q_table=USE_ALREADY_GENERATED_Q_TABLE))
cars.append(
    Car.Car(4, src1, dst1, START_TIME2, RN, route_algorithm="q", use_existing_q_table=USE_ALREADY_GENERATED_Q_TABLE))
